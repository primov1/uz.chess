...
__decorate([
    ...
    (0, class_validator_1.MaxLength)(128),
    (0, class_validator_1.IsOptional)(),
    (0, swagger_1.ApiPropertyOptional)({ description: 'Thumbnail path — set automatically if file uploaded' }),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    (0, swagger_1.ApiPropertyOptional)({ description: 'Video path — set automatically if file uploaded' }),
    __metadata("design:type", String)
