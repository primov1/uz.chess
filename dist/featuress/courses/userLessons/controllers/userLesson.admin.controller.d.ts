...
export declare class UserLessonAdminController {
    private readonly service;
    constructor(service: UserLessonAdminService);
    getAll(): Promise<UserLessonListAdminDto[]>;
    getOne(id: number): Promise<UserLessonDetailAdminDto>;
    create(payload: UserLessonCreateAdminDto): Promise<import("../entities/userLesson.entity").UserLesson>;
    update(id: number, payload: UserLessonUpdateAdminDto): Promise<import("../entities/userLesson.entity").UserLesson>;
