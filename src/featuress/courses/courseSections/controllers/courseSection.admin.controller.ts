...
export class CourseSectionAdminController {
  constructor(private readonly service: CourseSectionAdminService) {}
  @Get()
  ...
  @ApiOkResponse({ type: () => CourseSectionDetailAdminDto })
  ...
  @ApiOkResponse({ type: () => CourseSectionDetailAdminDto })
  create(@Body() payload: CourseSectionCreateAdminDto) {
