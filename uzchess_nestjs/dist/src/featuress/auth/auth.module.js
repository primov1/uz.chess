...
const auth_public_controller_1 = require("./controllers/auth.public.controller");
...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            auth_public_service_1.AuthPublicService,
            {
        ...
        exports: [auth_public_service_1.AuthPublicService, jwt_1.JwtModule],
    })
], AuthModule);
