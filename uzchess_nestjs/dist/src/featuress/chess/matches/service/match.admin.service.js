...
let MatchAdminService = class MatchAdminService {
    async getAll() {
        ...
        return (0, class_transformer_1.plainToInstance)(match_list_admin_dto_1.MatchListAdminDto, matches, {
    ...
    async getOne(id) {
        ...
        return (0, class_transformer_1.plainToInstance)(match_detail_admin_dto_1.MatchDetailAdminDto, match, {
            excludeExtraneousValues: true,
        });
    }
