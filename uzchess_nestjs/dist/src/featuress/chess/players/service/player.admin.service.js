...
let PlayerAdminService = class PlayerAdminService {
    async getAll() {
        ...
        return (0, class_transformer_1.plainToInstance)(player_list_admin_dto_1.PlayerListAdminDto, players, {
    ...
    async getOne(id) {
        ...
        return (0, class_transformer_1.plainToInstance)(player_detail_admin_dto_1.PlayerDetailAdminDto, player, {
            excludeExtraneousValues: true,
        });
    }
