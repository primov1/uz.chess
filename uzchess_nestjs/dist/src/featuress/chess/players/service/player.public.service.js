...
let PlayerPublicService = class PlayerPublicService {
    async getAll() {
        ...
        return (0, class_transformer_1.plainToInstance)(player_list_public_dto_1.PlayerListPublicDto, players, {
    ...
    async getOne(id) {
        ...
        return (0, class_transformer_1.plainToInstance)(player_detail_public_dto_1.PlayerDetailPublicDto, player, {
            excludeExtraneousValues: true,
        });
    }
};
