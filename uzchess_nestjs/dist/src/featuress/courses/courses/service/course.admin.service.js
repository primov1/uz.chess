...
let CourseAdminService = class CourseAdminService {
    async getAll() {
        ...
        return (0, class_transformer_1.plainToInstance)(course_list_admin_dto_1.CourseListAdminDto, items, {
    ...
    async getOne(id) {
        ...
        return (0, class_transformer_1.plainToInstance)(course_detail_admin_dto_1.CourseDetailAdminDto, item, {
            excludeExtraneousValues: true,
        });
    }
